            ...
            lists: [
                {
                    ...
                    title: 'Aging — red (75+ days in stage)',
                    table: 'x_cog_mah_awards_case',
                    condition: 'active=true^aging_flag=red^ORDERBYDESCdays_in_stage',
                ...
                },
                {
                    ...
                    title: 'Aging — amber (60–74 days in stage)',
                    table: 'x_cog_mah_awards_case',
                    condition: 'active=true^aging_flag=amber^ORDERBYDESCdays_in_stage',
                    columns: 'number,legacy_number,veteran_last_name,requester,stage,aging_flag,days_in_stage,priority,source_agency,authorization_date,assigned_to,line_count,total_quantity,sys_updated_on',
                    active: true,
                    order: 200,
                ...
                },
                {
                    ...
                    table: 'x_cog_mah_awards_case',
                    condition: 'active=true^on_hold=true^ORDERBYDESCdays_in_stage',
                    columns: 'number,legacy_number,veteran_last_name,requester,stage,aging_flag,days_in_stage,priority,source_agency,authorization_date,assigned_to,line_count,total_quantity,sys_updated_on',
                    active: true,
                    order: 300,
    ...
    tabs: [
        {
            ...
            widgets: [
                {
                    $id: Now.ID['ops_widget_count_active_cases'],
                    component: 'single-score',
                    componentProps: {
                        headerTitle: 'Active awards cases',
                        showZero: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_awards_case', filterQuery: 'active=true', id: 'ds_1' },
                        ],
                ...
                },
                {
                    ...
                    component: 'single-score',
                    componentProps: {
                        headerTitle: 'Red (75+ days in stage)',
                        showZero: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_awards_case', filterQuery: 'active=true^aging_flag=red', id: 'ds_1' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 6,
                ...
                },
                {
                    ...
                    component: 'single-score',
                    componentProps: {
                        headerTitle: 'Amber (60–74 days in stage)',
                        showZero: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_awards_case', filterQuery: 'active=true^aging_flag=amber', id: 'ds_1' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 6,
                ...
                },
                {
                    ...
                    componentProps: {
                        ...
                        showZero: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_awards_case', filterQuery: 'active=true^on_hold=true', id: 'ds_1' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 6,
                ...
                },
                {
                    ...
                    component: 'single-score',
                    componentProps: {
                        headerTitle: 'Engraving jobs open',
                        showZero: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_engraving_job', filterQuery: 'active=true^statusINqueued,in_progress,qc_hold,rework', id: 'ds_1' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 6,
                ...
                },
                {
                    ...
                    component: 'single-score',
                    componentProps: {
                        headerTitle: 'Requests at vendors',
                        showZero: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_heraldry_request', filterQuery: 'active=true^stateINreleased_to_vendor,in_production,shipped', id: 'ds_1' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 6,
                ...
                },
                {
                    ...
                    component: 'single-score',
                    componentProps: {
                        headerTitle: 'Open migration exceptions',
                        showZero: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_migration_exception', filterQuery: 'stateINopen,triaged', id: 'ds_1' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 6,
                ...
                },
                {
                    ...
                    component: 'single-score',
                    componentProps: {
                        headerTitle: 'Unmapped legacy statuses',
                        showZero: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_migration_exception', filterQuery: 'exception_typeINunmapped_status,unmapped_value^stateINopen,triaged', id: 'ds_1' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 6,
                ...
                },
                {
                    ...
                    componentProps: {
                        headerTitle: 'Active awards cases by stage',
                        showDataLabels: true,
                        showLegend: false,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_awards_case', filterQuery: 'active=true', id: 'ds_1' },
                        ...
                        groupBy: [
                            { groupBy: [{ dataSource: 'ds_1', groupByField: 'stage', isChoice: true }], maxNumberOfGroups: 'ALL', sortBy: 'value', sortByOrder: 'desc' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 16,
                ...
                },
                {
                    ...
                    component: 'donut',
                    componentProps: {
                        headerTitle: 'Active awards cases by aging flag',
                        showDataLabels: true,
                        showLegend: true,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_awards_case', filterQuery: 'active=true', id: 'ds_1' },
                        ...
                        groupBy: [
                            { groupBy: [{ dataSource: 'ds_1', groupByField: 'aging_flag', isChoice: true }], maxNumberOfGroups: 'ALL', sortBy: 'value', sortByOrder: 'desc' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 16,
                ...
                },
                {
                    ...
                    component: 'vertical-bar',
                    componentProps: {
                        headerTitle: 'Engraving queue by status',
                        showDataLabels: true,
                        showLegend: false,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_engraving_job', filterQuery: 'active=true^statusINqueued,in_progress,qc_hold,rework', id: 'ds_1' },
                        ...
                        groupBy: [
                            { groupBy: [{ dataSource: 'ds_1', groupByField: 'status', isChoice: true }], maxNumberOfGroups: 'ALL', sortBy: 'value', sortByOrder: 'desc' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 16,
                ...
                },
                {
                    ...
                    componentProps: {
                        ...
                        table: 'x_cog_mah_awards_case',
                        query: 'active=true^aging_flag=red^ORDERBYDESCdays_in_stage',
                        fixedQuery: '',
                        columns: 'number,legacy_number,veteran_last_name,requester,stage,aging_flag,days_in_stage,priority,source_agency,authorization_date,assigned_to,line_count,total_quantity,sys_updated_on',
                        limit: 15,
                        showBorder: true,
                ...
                },
                {
                    ...
                    componentProps: {
                        headerTitle: 'Vendor work by vendor and state',
                        newReporting: true,
                        dataCategory: 'group',
                        showZero: true,
                        ...
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_heraldry_request', filterQuery: 'active=true^stateINreleased_to_vendor,in_production,shipped', id: 'ds_1', dataCategories: ['trend', 'group', 'simple'] },
                        ],
                        groupBy: [
                            { groupBy: [{ dataSource: 'ds_1', groupByField: 'vendor', isChoice: false }], categoryIndex: 0, maxNumberOfGroups: 'ALL', numberOfGroupsBasedOn: 'NO_OF_GROUP_BASED_ON_PER_METRIC' },
                            { groupBy: [{ dataSource: 'ds_1', groupByField: 'state', isChoice: true }], categoryIndex: 1, maxNumberOfGroups: 'ALL', numberOfGroupsBasedOn: 'NO_OF_GROUP_BASED_ON_PER_METRIC' },
                        ],
                ...
                },
                {
                    ...
                    componentProps: {
                        headerTitle: 'Open migration exceptions by type',
                        showDataLabels: true,
                        showLegend: false,
                        dataSources: [
                            { sourceType: 'table', tableOrViewName: 'x_cog_mah_migration_exception', filterQuery: 'stateINopen,triaged', id: 'ds_1' },
                        ...
                        groupBy: [
                            { groupBy: [{ dataSource: 'ds_1', groupByField: 'exception_type', isChoice: true }], maxNumberOfGroups: 'ALL', sortBy: 'value', sortByOrder: 'desc' },
                        ],
                        metrics: [{ dataSource: 'ds_1', aggregateFunction: 'COUNT', axisId: 'primary' }],
                    },
                    width: 16,
