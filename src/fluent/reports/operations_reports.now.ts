...
export const opsReport_aging_distribution = Record({
    ...
    data: {
        ...
        description: 'Green / Amber (60+ days in stage) / Red (75+ days in stage) distribution of active awards cases, as scored by the nightly aging job.',
        table: 'x_cog_mah_awards_case',
        report_source: ops_source_awards_case,
        type: 'donut',
        filter: 'active=true',
...
export const opsReport_aging_red_cases = Record({
    ...
    data: {
        ...
        description: 'Active awards cases whose current stage has lasted 75+ days (aging flag red), longest first. Days in stage restart at every stage change; the authorization-to-shipment clock is the SLA.',
        table: 'x_cog_mah_awards_case',
        report_source: ops_source_awards_case,
        type: 'list',
...
export const opsReport_aging_amber_cases = Record({
    ...
    data: {
        ...
        description: 'Active awards cases whose current stage has lasted 60–74 days (aging flag amber), longest first. Days in stage restart at every stage change; the authorization-to-shipment clock is the SLA.',
        table: 'x_cog_mah_awards_case',
        report_source: ops_source_awards_case,
        type: 'list',
...
export const opsReport_cases_on_hold = Record({
    ...
    data: {
        ...
        report_source: ops_source_awards_case,
        type: 'list',
        filter: 'active=true^on_hold=true^ORDERBYDESCdays_in_stage',
        field_list: 'number,legacy_number,veteran_last_name,requester,stage,aging_flag,days_in_stage,priority,source_agency,authorization_date,assigned_to,line_count,total_quantity,sys_updated_on',
        roles: ['x_cog_mah.tacom_staff', 'x_cog_mah.csr', 'x_cog_mah.engraver', 'x_cog_mah.assembler', 'x_cog_mah.warehouse', 'x_cog_mah.dla', 'x_cog_mah.admin'],
        is_published: false,
    },
